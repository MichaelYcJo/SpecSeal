...
key in silence (#227, `docs/round-record-spec.md` §*The finding id*).
...
depth refusal on the finding's `Location` (`docs/round-record-spec.md`
...
its own table calls open. It is the one word rather than a vocabulary test:
