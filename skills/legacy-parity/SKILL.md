...
description: |
  ...
  Use when: a project declares a migration config (docs/parity.md), porting or
...
## Migration config — `docs/parity.md`
...
`docs/policies/<domain>/_evidence.md` maps spec clauses to **original**
