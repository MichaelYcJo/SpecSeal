...
| The axes table carries a security row, and a paste-ready fix at an OS boundary states its assumed precondition | `skills/code-review/SKILL.md#"## Comparison axes"@1a4db332`, `skills/code-review/SKILL.md#"## Findings format"@6d56ea73` | Read, pinned by `test_review_axes.py` (the row and its probes) and the new test file (the sentence and the five boundary premises) | 2026-09-01 | Security was named in stage 2 and absent from the table, and the table is what makes an axis mandatory |
