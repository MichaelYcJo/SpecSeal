# 1790297086-the-broad-gate-says-what-ci-says — routing
...
| Branch | fix/596-the-broad-gate-says-what-ci-says |
...
#596, #473, #499, #462, #463 and #482, the broad gate and the cases that read the workflow it mirrors: every one is the gate or its cases saying something CI does not. The owner pressed `automation` once for every work item of `release: 0.15.4` in one question.
