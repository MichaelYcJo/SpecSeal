...
| 3 | The closing set: ledger fragment, changelog fragment, `overview.md`, and `docs/flow.md`'s #156 box | the modules that read those, `evidence-check`, and the orchestrator's broad gate after the rounds | 4eed667 |
