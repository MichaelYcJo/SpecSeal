...
| 3 | Records: changelog fragment, ledger fragment, `docs/flow.md` rows, overview, phase records | `evidence_check.py --strict --ledger … .` exit 0, `rider_check.py` exit 0, `bin/test` on 8 modules | c37c412 |
