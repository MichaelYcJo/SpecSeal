...
| 4 | The fragments: `seal/specs/1788472135-the-run-outlives-its-last-finding/changelog.md` and `seal/ledger/1788472135-the-run-outlives-its-last-finding.md` | `.github/scripts/fold_ledger.py --check`, and `evidence-check` against the new rows | |
