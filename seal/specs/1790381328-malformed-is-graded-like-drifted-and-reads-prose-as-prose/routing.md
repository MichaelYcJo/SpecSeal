# 1790381328-malformed-is-graded-like-drifted-and-reads-prose-as-prose — routing
...
| Branch | fix/614-malformed-is-graded-like-drifted-and-reads-prose-as-prose |
...
#614, `MALFORMED`'s rule (a): three edges where prose is refused or a coordinate is missed. The owner answered #606's Q1 in the same batch: (b), `MALFORMED` is graded like `DRIFTED`. The owner pressed `automation` once for every work item of `release: 0.15.5` in one question.
