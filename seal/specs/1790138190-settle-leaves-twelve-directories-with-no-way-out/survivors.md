...
| `seal/specs/1790138190-settle-leaves-twelve-directories-with-no-way-out/spec.md` | deletes a | Still true: a spec deleted in one commit and the directory in the next is still a deletion. Round 1's finding 3 widened it to a spec deleted by an earlier pull request, and nothing the sentence says became false |
