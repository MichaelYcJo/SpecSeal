...
| the quoted rider stamp inside `seal/specs/1788184145-…/rounds/round-2.md` still reads `Verified 2026-08-31 at f1cd65d`. It is a record of what a round observed, so the `Target SHA` argument exempts it — but it is the one place the old string survives a `grep` | the repository owner (`questions.md` C1) |
