...
| #526 item 3, the shape and ceiling checks as plugin commands | A `bin/` wrapper pair and README rows `tests/test_chain_hooks_hardening.py` derives; not a prose edit. Home: #566 (moved out of #526's checklist by the orchestrator) |
