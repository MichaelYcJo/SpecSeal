...
| 4 | The fragments, and `docs/flow.md` — this ticket's box, and a row for the outcome-column ticket this work opens | `evidence-check --ledger`, `fold_ledger --dry-run`, `unverified-check` | `b353704` |
