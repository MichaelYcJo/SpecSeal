...
| Needs a fix | yes — 🟡 1 three `seal/ledger.md` rows assert a read on a date the content did not exist; 🟡 2 the refusal's reach is the SHA a verdict cell happens to carry, and 19 of this repository's 231 fix-word cells carry none; 🟡 3 `found[-1]` is undefended and is the permissive direction; 🟡 4 the skipped-ledger comparison folds case on Windows alone |
