...
| Whether `st_ino == 0` arrives on `windows-latest` — **answered** at `3bf0fd6`, run 33939786295: the cases that build a zero inode and the fallback ran there and passed. This row said the leg still owed it until round 13's 🟡 5 | 🔴 8's grounds; `phases/phase-15.md` | closed by the leg's own run |
