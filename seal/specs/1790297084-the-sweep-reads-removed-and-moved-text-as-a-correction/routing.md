# 1790297084-the-sweep-reads-removed-and-moved-text-as-a-correction — routing
...
| Branch | fix/603-the-sweep-reads-removed-and-moved-text-as-a-correction |
...
#603, #591 and #592, the survivor sweep: the cells of a removed ledger row, text a settle fold moved, and the coordinate a moved-only path is named by. The owner pressed `automation` once for every work item of `release: 0.15.4` in one question.
