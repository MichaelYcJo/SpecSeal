...
**Nothing here quotes the phrases the check matched.** This file is inside the
corpus the check searches, so a phrase written here counts as wording the
range ADDED and is subtracted from what is looked for at all — the report goes
