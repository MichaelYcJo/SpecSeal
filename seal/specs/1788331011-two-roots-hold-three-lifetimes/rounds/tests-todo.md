...
| Asserts | Destination |
|---|---|
| ✅ a symlinked `.specseal/` is refused with a line naming the by-hand section, nothing moves, nothing is stamped (round-2 🟡 A) — `test_a_symlinked_specseal_is_refused_not_half_moved`, planted at 9f400d0 | `tests/test_the_root_migrates_itself.py` |
