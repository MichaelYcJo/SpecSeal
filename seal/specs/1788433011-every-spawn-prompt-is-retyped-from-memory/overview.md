...
|---|---|
| ✅ The full suite (this repository carries no typecheck step) | the orchestrator, once, after the review rounds settled — `1821 passed, 1 skipped` at `b49cfb9`, `uvx --with pytest --with pytest-xdist python3 -m pytest tests/ -q -n auto`, exit 0 |
