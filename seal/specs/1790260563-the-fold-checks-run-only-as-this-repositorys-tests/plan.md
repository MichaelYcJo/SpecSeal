...
| Keep `SHAPE_CUTOFF`, `LINE_CEILING`, `OVER_CEILING` as test constants beside the rows | A third copy of each value, and a pin whose only job is holding the copies equal | rejected |
