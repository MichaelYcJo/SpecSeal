...
| Whether the two size limits are the right numbers — 32 MB a member, 512 MB a zip. Round 1 measured the unbounded read (408 KB declaring 400 MB wrote 419 MB in 0.2 s) and the limits answer it, but no record has approached either | the repository owner, at the first root that meets one |
