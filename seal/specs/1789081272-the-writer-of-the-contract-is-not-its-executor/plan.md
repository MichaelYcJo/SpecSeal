...
| 6 | `docs/flow.md` — step 2 loses *once #84 exists*, 0.11.0's section ticks its box. The fragments: `seal/specs/<id>/changelog.md` and `seal/ledger/<id>.md`. The closing memo | S12 executed · `fold_ledger.py --check` · the release-hygiene case | `226a03d` |
