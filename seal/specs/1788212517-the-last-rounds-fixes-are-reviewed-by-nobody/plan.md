...
| 13 | Q3's first measurement recorded, the ledger rows and stamps, the changelog and the memo | `evidence_check.py`, `unverified_check.py`, `test_release_hygiene`, `test_ledger_stamps_resolve`, and the check run against a fresh clone in both directions | `9c248a2` |
