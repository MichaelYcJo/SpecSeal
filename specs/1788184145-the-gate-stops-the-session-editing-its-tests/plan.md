...
| 3 | `questions.md` Q1, the `## Unreleased` changelog entry, the ledger row and the closing memo | `test_release_hygiene`, `test_ledger_stamps_resolve`, `evidence_check.py`, `unverified_check.py`, `test_chain_hooks_hardening::test_plugin_version_is_in_changelog` | `f805088` |
